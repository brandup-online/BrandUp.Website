...
var Page = /** @class */ (function (_super) {
    ...
    Page.prototype.onCallbackHandler = function (data) { };
    ...
    Page.prototype.callbackHandler = function (data) {
    ...
    Page.prototype.submit = function (form) {
        ...
        this.website.app.submit({ form: form, button: null });
    };
        ...
        var _loop_1 = function (i) {
            ...
            if (script) {
                script.then(function (t) {
                    if (!_this.__scripts)
                        return;
                    var uiElem = new t.default(elem, _this.website, _this);
