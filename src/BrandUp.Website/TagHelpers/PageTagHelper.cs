...
namespace BrandUp.Website.TagHelpers
{
    ...
    public class PageTagHelper : TagHelper
    {
        ...
        {
            if (ViewContext.ViewData.Model is AppPageModel appPageModel && appPageModel.RequestMode == AppPageRequestMode.Content && ViewContext.View is RazorView razorView)
